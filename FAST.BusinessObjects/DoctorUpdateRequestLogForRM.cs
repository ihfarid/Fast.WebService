...
{
	[Serializable]
	public class DoctorUpdateRequestLogForRM : BusinessObject, IDisposable
	{
		#region property
		...
		public DoctorUpdateRequestLogForRM()
		{
			_bIsDisposed=false;
	...
	[Serializable]
    public class DoctorUpdateRequestLogForRMs : CollectionBase, IEnumerable
	{
        public DoctorUpdateRequestLogForRMs()
		{
			InnerList.Clear();		}
        public void Add(DoctorUpdateRequestLogForRM oItem)
		{
			InnerList.Add(oItem);
		}
        public DoctorUpdateRequestLogForRM this[int i]
		{
            get { return (DoctorUpdateRequestLogForRM)InnerList[i]; }
		}
		public int GetIndex(int nID)
		{
			...
			{
                oItem = (DoctorUpdateRequestLogForRM)InnerList[i];
        ...
        public DoctorUpdateRequestLogForRM GetDoctorUpdateRequestForRM(int nID)
		{
            DoctorUpdateRequestLogForRM oItem = new DoctorUpdateRequestLogForRM();
            foreach (DoctorUpdateRequestLogForRM oDoctorUpdateRequestForRM in this)
			{
                if (oDoctorUpdateRequestForRM.ID.ToInt32 == nID)
				{
                    oItem = oDoctorUpdateRequestForRM;
					break;
				}
			}
			return oItem;
